...
const Navbar = React.memo(function Navbar({ links, ctaLabel, onCtaClick }: NavbarProps) {
  ...
  return (
    <header style={{ background: '#fff', position: 'sticky', top: 0, zIndex: 50, borderBottom: '1px solid #F3F4F6', boxShadow: '0 1px 12px rgba(139,92,246,0.08)' }}>
      <div style={{ height: 64, padding: '0 40px', display: 'flex', alignItems: 'center', gap: 16 }}>
        ...
        {/* Search bar with location pill inside */}
        <div style={{ flex: 1, display: 'flex', alignItems: 'center', background: '#F9F9F9', border: '1px solid #E7E1FF', borderRadius: 100, height: 40, overflow: 'hidden' }}>
          {/* Location pill */}
          <button style={{
            display: 'flex', alignItems: 'center', gap: 5,
            background: '#fff', border: 'none', borderRight: '1px solid #E7E1FF',
            borderRadius: '100px 0 0 100px', padding: '0 14px', height: '100%',
        ...
        <div style={{ position: 'relative', flexShrink: 0 }}>
          ...
          <span style={{
            ...
            width: 16, height: 16, background: '#7C5CFC', borderRadius: '50%',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontFamily: 'Poppins,sans-serif', fontSize: 10, fontWeight: 600, color: '#fff',
          }}>1</span>
        </div>

        {/* Cart button */}
        <button onClick={onCtaClick} style={{
          height: 40, borderRadius: 100, padding: '0 18px',
          background: '#101129', border: 'none',
          display: 'flex', alignItems: 'center', gap: 8,
          cursor: 'pointer', flexShrink: 0,
        }}>
          <svg width="16" height="14" viewBox="0 0 20 18" fill="none">
            <path d="M1 1H3.25L4.2 3M4.2 3H19L16 10H6L4.2 3ZM7 15C7 15.55 6.8 16.02 6.41 16.41C6.02 16.8 5.55 17 5 17C4.45 17 3.98 16.8 3.59 16.41C3.2 16.02 3 15.55 3 15C3 14.45 3.2 13.98 3.59 13.59C3.98 13.2 4.45 13 5 13C5.55 13 6.02 13.2 6.41 13.59C6.8 13.98 7 14.45 7 15ZM17 15C17 15.55 16.8 16.02 16.41 16.41C16.02 16.8 15.55 17 15 17C14.45 17 13.98 16.8 13.59 16.41C13.2 16.02 13 15.55 13 15C13 14.45 13.2 13.98 13.59 13.59C13.98 13.2 14.45 13 15 13C15.55 13 16.02 13.2 16.41 13.59C16.8 13.98 17 14.45 17 15Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <span style={{ fontFamily: 'Poppins,sans-serif', fontSize: 13, fontWeight: 600, color: '#fff' }}>{ctaLabel}</span>
        </button>
